...
public class AlarmAgent {
     ...
     */
    public void init() {
        // 创建一个线程，任务：故障检测节点与报警中心建立连接
        Thread connectingThread = new Thread(new ConnectingTask());
        connectingThread.start();

        // 创建定时调度线程池(核心池：4个)，用于心跳检测
        ...
        // 心跳检测在第2s开始执行，每5s执行一次
        heartbeatExecutor.scheduleAtFixedRate(new HeartbeatTask(), 2000, 5000
